...
# Please note, the TaxPhlAn pipeline for SLST Design (Module A) uses the NCBI program 'tbl2asn' which expires every year! Therefore, please be sure to check if this tool is up-to-date before running your analyses (last update: 18 November 2019).
